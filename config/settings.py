...
DATABASE_URL = os.environ.get('DATABASE_URL', 'postgresql://postgres:123456@localhost:5432/viewset_and_generic_db')
DATABASES = {'default': dj_database_url.config(default=DATABASE_URL)}
#DATABASES = {
#    'default': {
#        'ENGINE': 'django.db.backends.postgresql_psycopg2',
#        'NAME': 'viewset_and_generic_db',
#        'USER': 'postgres',
#        'PASSWORD': '123456',
#        'HOST': 'localhost',
#        'PORT': '5432',
...
CELERY_BEAT_SCHEDULE = {
    'update-user-activity-status-every-10-minutes': {
        'task': 'lms.tasks.update_user_activity_status',
